...
dependencies="whiptail git sudo curl wget lsof fail2ban apache2-utils tcl tcl-dev build-essential dirmngr apt-transport-https bc uuid-runtime jq net-tools gnupg2 cracklib-runtime unzip ccze"

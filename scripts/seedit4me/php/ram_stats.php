...
?>
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <!--div class="vertical-container"-->
            <p style="font-size:10px">phys mem: <?php ; ?>%<br/>
              phys used: <font color='#eb4549'><?php echo "$mu"; ?></font>  | phys idle: <font color='#eb4549'><?php echo "$mf"; ?></font>
            </p>
        ...
        <div class="col-sm-12" style="padding-top:10px">
          <!--div class="vertical-container"-->
            <p style="font-size:10px">cached mem: <?php echo "$memCachedPercent"; ?>%<br/>
              cached used <?php echo "$mc"; ?> | cached buffers; ?> <?php echo "$mb"; ?></p>
            <div class="progress progress-striped">
              <?php
        ...
        <div class="col-sm-12" style="padding-top:10px">
          <!--div class="vertical-container"-->
            <p style="font-size:10px">real mem: <?php echo "$memRealPercent"; ?>%<br/>
              real mem used <?php echo "$memRealUsed"; ?> | real free; ?> <?php echo "$memRealFree"; ?></p>
            <div class="progress progress-striped">
              <?php
        ...
        <div class="col-sm-12" style="padding-top:10px">
          <!--div class="vertical-container"-->
            <p style="font-size:10px">swap mem: <?php echo "$swapPercent"; ?>%<br/>
              swap total: total <?php echo $st;?> | swap used; ?> <?php echo "$su"; ?> | swap idle <?php echo "$sf"; ?></p>
            <div class="progress progress-striped">
              <?php
      ...
      <h4 class="nomargin"><?php echo $memTotal;?>
        <a href="?clean_mem=true" id="cleanmem" data-toggle="modal" data-target="#sysResponse" style="margin: 0 auto"> <button class="btn btn-xs btn-default pull-right">clear cache</button></a>
      </h4>
